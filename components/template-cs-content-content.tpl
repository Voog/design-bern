:root {
  ...
  */
  ...
  /* VoogStyle
    ...
    "scope": "global",
    "boundVariables": [
      "--menu-sub-hover-color",
      "--menu-sub-active-color"
    ]
  */
  --menu-sub-color: #1b2124;
  /* VoogStyle
    "pathI18n": ["content", "sub_menu", "hover"],
    "titleI18n": "color",
    "type": "button",
  ...
  */
  ...
  /* VoogStyle
    ...
    "scope": "global"
  */
  --content-body-text-color: #696b6c;
  /* VoogStyle
  ...
  */
  ...
  /* VoogStyle
    ...
    "scope": "global"
  */
  --content-area-product-title__alignment: center;
  /* VoogStyle
    "pathI18n": ["product", "title"],
    "titleI18n": "size",
    "editor": "rangePicker",
  ...
  */
  ...
  /* VoogStyle
    ...
    "scope": "global"
  */
  --content-area-product-title__font-weight: 600;
  /* VoogStyle
    "pathI18n": ["product", "title"],
    "titleI18n": "font_style",
    "type": "button",
  ...
  */
  ...
  /* VoogStyle
    ...
    "scope": "global"
  */
  --content-area-product-title__color: #696b6c;
  /* VoogStyle
  ...
  */
  ...
  /* VoogStyle
    ...
    "scope": "global"
  */
  --content-area-product-price__font-weight: 600;
  /* VoogStyle
    "pathI18n": ["product", "price"],
    "titleI18n": "font_style",
    "type": "button",
  ...
  */
  ...
  /* VoogStyle
    ...
    "scope": "global"
  */
  --content-area-product-price__color: #696b6c;
  /* VoogStyle
    ...
    "scope": "global"
  */
  --content-area-product-description__font-size: 24px;
  /* VoogStyle
    "pathI18n": ["product", "description"],
    "titleI18n": "font_size",
    "type": "button",
