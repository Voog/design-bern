...
{% stylesheet_link "main.min.css?v=bern-2.3.0" %}
{% if editmode %}{% stylesheet_link "editmode.min.css?v=bern-2.3.0" %}{% endif %}
<!--[if lt IE 9]>{% stylesheet_link "ie8.min.css?v=bern-2.3.0" %}<![endif]-->
